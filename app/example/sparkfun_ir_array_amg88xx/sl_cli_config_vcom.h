...
// <i> Priority of the CLI instance task using the CMSIS order and using the
//   enum name
...
// <i> Default: 0
// <i> Specifies the delay in milliseconds before the cli task start to poll for
//   input.
#define SL_CLI_VCOM_TASK_START_DELAY_MS   0

// <o SL_CLI_VCOM_TASK_LOOP_DELAY_MS> CLI task loop delay
// <i> Default: 50
// <i> Specifies the delay in milliseconds after the cli task has polled the
//   input.
