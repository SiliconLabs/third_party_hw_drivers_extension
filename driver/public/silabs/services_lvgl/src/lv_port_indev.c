...
/* Copy this file as "lv_port_indev.c" and set this value to "1"
 * to enable content */
#if 1
...
static void keypad_read(lv_indev_drv_t *indev_drv, lv_indev_data_t *data)
{
  ...
  if (act_key != 0) {
    ...
    /* Translate the keys to LVGL control characters
     * according to your key definitions */
    switch (act_key) {
      case 1:
        act_key = LV_KEY_NEXT;
        break;
