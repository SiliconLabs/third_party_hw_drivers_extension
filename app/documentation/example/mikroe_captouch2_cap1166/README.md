...
2. Copy the file [app.c](https://github.com/SiliconLabs/platform_hardware_drivers_sdk_extensions/tree/master/app/example/mikroe_captouch2_cap1166) (overwriting existing file), into the project root folder.
