/***************************************************************************//**
 * @file sparkfun_ak9753_platform.c
                                                   ...
                                                   uint8_t *pdata)
{
  ...
  if ((pdata == NULL) || (sparkfun_ak9753_i2cpsm_instance == NULL)) {
    return SL_STATUS_INVALID_PARAMETER;
  } else {
    seq.addr = SPARKFUN_AK9753_ADDR << 1;
    ...
    if (I2CSPM_Transfer(sparkfun_ak9753_i2cpsm_instance,
                        &seq) != i2cTransferDone) {
                                                    ...
                                                    uint8_t data)
{
  ...
  if (sparkfun_ak9753_i2cpsm_instance == NULL) {
    return SL_STATUS_INVALID_PARAMETER;
  }
