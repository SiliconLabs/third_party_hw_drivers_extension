...
/***************************************************************************//**
 * @brief
 *    This function returns the boot state of the device (1:booted, 0:not
 *   booted).
 *
 * @param[in] dev
 *    Device address. (Default: 0x29[0x52])
 ...
 *    SL_STATUS_TRANSMIT if I2C transmit failed.
 ******************************************************************************/
sl_status_t vl53l1x_get_signal_per_spad(uint16_t dev,
...
/***************************************************************************//**
 * @brief
 * This function programs the xtalk correction value in cps (Count Per
 *   Second).\n
 ...
 *    SL_STATUS_TRANSMIT if I2C transmit failed.
 ******************************************************************************/
sl_status_t vl53l1x_set_distance_threshold(uint16_t dev,
...
sl_status_t vl53l1x_calibrate_offset(uint16_t dev,
                                     uint16_t target_distance_in_mm,
                                     int16_t *offset);
