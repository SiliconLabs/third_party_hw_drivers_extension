...
2. Copy the file [app.c](https://github.com/SiliconLabs/platform_hardware_drivers_sdk_extensions/tree/master/app/example/mikroe_brushless16_lb11685av) (overwriting existing file), into the project root folder.
