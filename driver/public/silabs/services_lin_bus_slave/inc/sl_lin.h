 ...
 * 0.42 msecs safety margin after
 * the transmission (8.4 bits, 16128 HF ticks at 38.4 MHz)
 * and 0.9 msecs safety margin before
 * the next one (18 bits, 34560 HF ticks at 38.4 MHz)
 ...
 */
sl_status_t sl_lin_slave_register_writable_endpoint(
  uint8_t frame_id,
  int len,
 ...
 *             It's safe to call this function anytime.
 */
sl_status_t sl_lin_slave_register_readable_endpoint(
  uint8_t frame_id,
  int len,
  sl_lin_callback_t callback,
  uint8_t *initdata,
