/***************************************************************************//**
 * @file sparkfun_as7265x_platform.h
...
#ifndef _SPARKFUN_AS7265X_PLATFORM_H_
#define _SPARKFUN_AS7265X_PLATFORM_H_
...
#define sparkfun_as7265x_get_tick_count() sl_sleeptimer_get_tick_count()
...
#define sparkfun_as7265x_delay_us(us)     sl_udelay_wait(us)
 ...
 *
 * @param[in] dev
 *    I2C address, default: SPARKFUN_AS.
 * @param[in] addr
 *    Address of register.
 * @param[out] pdata
 ...
 *
 ******************************************************************************/
sl_status_t sparkfun_as7265x_platform_read_register(uint8_t dev,
                                                    uint8_t addr,
                                                    uint8_t *pdata);
 ...
 *
 * @param[in] dev
 *    I2C address, default: SPARKFUN_AS7265X_ADDR.
 * @param[in] addr
 *    Address of register.
 * @param[out] pdata
 *    Pointer of output value.
 ...
 *
 ******************************************************************************/
sl_status_t sparkfun_as7265x_platform_write_register(uint8_t dev,
                                                     uint8_t addr,
                                                     uint8_t data);
