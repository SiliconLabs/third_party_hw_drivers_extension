 ...
 * ...
 *
 *   sparkfun_id12la_init(sl_i2cspm_rfid);
 *
 *   while(1)
 *   {
 *
 *     sparkfun_id12la_get_all_tag(&id12la_all_tag_data, &count_tag);
 *
 * ...
 *
 *   }
 ...
 *    sl_status_t error code
 ******************************************************************************/
sl_status_t sparkfun_id12la_scan_address(void);
