 ...
 ******************************************************************************/
#ifndef SPARKFUN_VCNL4040_H_
#define SPARKFUN_VCNL4040_H_
...
// Device ID of the VCNL4040 chip
#define SPARKFUN_VCNL4040_DEVICE_ID                    0x0186
...
#define SPARKFUN_VCNL4040_I2C_BUS_ADDRESS              0x60

/************************************************/
/**\name    VCNL4040 Command Codes       */
/***********************************************/
#define SPARKFUN_VCNL4040_ALS_CONF                     0x00
#define SPARKFUN_VCNL4040_ALS_THDH                     0x01
#define SPARKFUN_VCNL4040_ALS_THDL                     0x02
#define SPARKFUN_VCNL4040_PS_CONF1                     0x03 // Lower
#define SPARKFUN_VCNL4040_PS_CONF2                     0x03 // Upper
#define SPARKFUN_VCNL4040_PS_CONF3                     0x04 // Lower
#define SPARKFUN_VCNL4040_PS_MS                        0x04 // Upper
#define SPARKFUN_VCNL4040_PS_CANC                      0x05
#define SPARKFUN_VCNL4040_PS_THDL                      0x06
#define SPARKFUN_VCNL4040_PS_THDH                      0x07
#define SPARKFUN_VCNL4040_PS_DATA                      0x08
#define SPARKFUN_VCNL4040_ALS_DATA                     0x09
#define SPARKFUN_VCNL4040_WHITE_DATA                   0x0A
#define SPARKFUN_VCNL4040_INT_FLAG                     0x0B // Upper
#define SPARKFUN_VCNL4040_ID                           0x0C

#define SPARKFUN_VCNL4040_PS_DUTY_MASK                 ~((1 << 7) | (1 << 6))
#define SPARKFUN_VCNL4040_PS_DUTY_40                   0
#define SPARKFUN_VCNL4040_PS_DUTY_80                   (1 << 6)
#define SPARKFUN_VCNL4040_PS_DUTY_160                  (1 << 7)
#define SPARKFUN_VCNL4040_PS_DUTY_320                  ((1 << 7) | (1 << 6))

#define SPARKFUN_VCNL4040_PS_PERS_MASK                 ~((1 << 5) | (1 << 4))
#define SPARKFUN_VCNL4040_PS_PERS_1                    0
#define SPARKFUN_VCNL4040_PS_PERS_2                    (1 << 4)
#define SPARKFUN_VCNL4040_PS_PERS_3                    (1 << 5)
#define SPARKFUN_VCNL4040_PS_PERS_4                    ((1 << 5) | (1 << 4))

#define SPARKFUN_VCNL4040_ALS_PERS_MASK                ~((1 << 3) | (1 << 2))
#define SPARKFUN_VCNL4040_ALS_PERS_1                   0
#define SPARKFUN_VCNL4040_ALS_PERS_2                   (1 << 2)
#define SPARKFUN_VCNL4040_ALS_PERS_4                   (1 << 3)
#define SPARKFUN_VCNL4040_ALS_PERS_8                   ((1 << 3) | (1 << 2))

#define SPARKFUN_VCNL4040_ALS_INT_EN_MASK              ~(1 << 1)
#define SPARKFUN_VCNL4040_ALS_INT_DISABLE              0
#define SPARKFUN_VCNL4040_ALS_INT_ENABLE               (1 << 1)

#define SPARKFUN_VCNL4040_ALS_SD_MASK                  ~(1 << 0)
#define SPARKFUN_VCNL4040_ALS_SD_POWER_ON              0
#define SPARKFUN_VCNL4040_ALS_SD_POWER_OFF             (1 << 0)

#define SPARKFUN_VCNL4040_ALS_IT_MASK                  ~((1 << 7) | (1 << 6))
#define SPARKFUN_VCNL4040_ALS_IT_80MS                  0
#define SPARKFUN_VCNL4040_ALS_IT_160MS                 (1 << 6)
#define SPARKFUN_VCNL4040_ALS_IT_320MS                 (1 << 7)
#define SPARKFUN_VCNL4040_ALS_IT_640MS                 ((1 << 7) | (1 << 6))

#define SPARKFUN_VCNL4040_PS_IT_MASK                   ~((1 << \
                                                          3)   \
                                                         | (1 << 2) | (1 << 1))
#define SPARKFUN_VCNL4040_PS_IT_1T                     0
#define SPARKFUN_VCNL4040_PS_IT_15T                    (1 << 1)
#define SPARKFUN_VCNL4040_PS_IT_2T                     (1 << 2)
#define SPARKFUN_VCNL4040_PS_IT_25T                    ((1 << 2) | (1 << 1))
#define SPARKFUN_VCNL4040_PS_IT_3T                     (1 << 3)
#define SPARKFUN_VCNL4040_PS_IT_35T                    ((1 << 3) | (1 << 1))
#define SPARKFUN_VCNL4040_PS_IT_4T                     ((1 << 3) | (1 << 2))
#define SPARKFUN_VCNL4040_PS_IT_8T                     ((1 << \
                                                         3)   \
                                                        | (1 << 2) | (1 << 1))

#define SPARKFUN_VCNL4040_PS_SD_MASK                   ~(1 << 0)
#define SPARKFUN_VCNL4040_PS_SD_POWER_ON               0
#define SPARKFUN_VCNL4040_PS_SD_POWER_OFF              (1 << 0)

#define SPARKFUN_VCNL4040_PS_HD_MASK                   ~(1 << 3)
#define SPARKFUN_VCNL4040_PS_HD_12_BIT                 0
#define SPARKFUN_VCNL4040_PS_HD_16_BIT                 (1 << 3)

#define SPARKFUN_VCNL4040_PS_INT_MASK                  ~((1 << 1) | (1 << 0))
#define SPARKFUN_VCNL4040_PS_INT_DISABLE               0
#define SPARKFUN_VCNL4040_PS_INT_CLOSE                 (1 << 0)
#define SPARKFUN_VCNL4040_PS_INT_AWAY                  (1 << 1)
#define SPARKFUN_VCNL4040_PS_INT_BOTH                  ((1 << 1) | (1 << 0))

#define SPARKFUN_VCNL4040_PS_SMART_PERS_MASK           ~(1 << 4)
#define SPARKFUN_VCNL4040_PS_SMART_PERS_DISABLE        0
#define SPARKFUN_VCNL4040_PS_SMART_PERS_ENABLE         (1 << 1)

#define SPARKFUN_VCNL4040_PS_AF_MASK                   ~(1 << 3)
#define SPARKFUN_VCNL4040_PS_AF_DISABLE                0
#define SPARKFUN_VCNL4040_PS_AF_ENABLE                 (1 << 3)

#define SPARKFUN_VCNL4040_PS_TRIG_MASK                 ~(1 << 2)
#define SPARKFUN_VCNL4040_PS_TRIG_TRIGGER              (1 << 2)

#define SPARKFUN_VCNL4040_WHITE_EN_MASK                ~(1 << 7)
#define SPARKFUN_VCNL4040_WHITE_ENABLE                 0
#define SPARKFUN_VCNL4040_WHITE_DISABLE                (1 << 7)

#define SPARKFUN_VCNL4040_PS_MS_MASK                   ~(1 << 6)
#define SPARKFUN_VCNL4040_PS_MS_DISABLE                0
#define SPARKFUN_VCNL4040_PS_MS_ENABLE                 (1 << 6)

#define SPARKFUN_VCNL4040_LED_I_MASK                   ~((1 << \
                                                          2)   \
                                                         | (1 << 1) | (1 << 0))
#define SPARKFUN_VCNL4040_LED_50MA                     0
#define SPARKFUN_VCNL4040_LED_75MA                     (1 << 1)
#define SPARKFUN_VCNL4040_LED_100MA                    (1 << 1)
#define SPARKFUN_VCNL4040_LED_120MA                    ((1 << 1) | (1 << 0))
#define SPARKFUN_VCNL4040_LED_140MA                    (1 << 2)
#define SPARKFUN_VCNL4040_LED_160MA                    ((1 << 2) | (1 << 0))
#define SPARKFUN_VCNL4040_LED_180MA                    ((1 << 2) | (1 << 1))
#define SPARKFUN_VCNL4040_LED_200MA                    ((1 << \
                                                         2)   \
                                                        | (1 << 1) | (1 << 0))

#define SPARKFUN_VCNL4040_INT_FLAG_ALS_LOW             (1 << 5)
#define SPARKFUN_VCNL4040_INT_FLAG_ALS_HIGH            (1 << 4)
#define SPARKFUN_VCNL4040_INT_FLAG_CLOSE               (1 << 1)
#define SPARKFUN_VCNL4040_INT_FLAG_AWAY                (1 << 0)

#define SPARKFUN_VCNL4040_INT_AWAY_MASK                (1 << 0)
#define SPARKFUN_VCNL4040_INT_CLOSE_MASK               (1 << 1)
#define SPARKFUN_VCNL4040_INT_LIGHT_MASK               (1 << 4)
#define SPARKFUN_VCNL4040_INT_DARK_MASK                (1 << 5)
...
} sparkfun_vcnl4040_core_version_t;
...
typedef struct {
  ...
  bool     PSSmartPersEnabled;   /*!< proximity sensor smart persistence
                                  *   enable/disable */
  bool     PSActiveForceEnabled; /*!< proximity sensor avctive force mode
                                  *   enable/disable */
  bool     PSLogicEnabled;       /*!< proximity sensor detection logic output
                                  *   mode enable/disable */
  ...
  uint16_t ALSHighThreshold;     /*!< ambient light sensor high interrupt
                                  *   threshold */
  uint16_t ALSLowThreshold;      /*!< ambient light sensor low interrupt
                                  *   threshold */
  bool     ALSEnabled;           /*!< ambient light sensor enable/disable */
  bool     ALSIntEnabled;        /*!< ambient light sensor interrupt
                                  *   enable/disable */
  bool     WhiteEnabled;         /*!< white channle enable/disable */
} SPARKFUN_VCNL4040_Sensor_Config_TypeDef;
...
} sparkfun_vcnl4040_irq_source_t;
 ...
 *   TBD.
 ******************************************************************************/
typedef void (*sparkfun_vcnl4040_norm_interrupt_callback_t)(
  sparkfun_vcnl4040_irq_source_t irq);
// -----------------------------------------------------------------------------
 ...
 *  SL_STATUS_TRANSMIT if I2C transmit failed.
 ******************************************************************************/
sl_status_t sparkfun_vcnl4040_set_proximity_integration_time(
  uint8_t time_value);
 ...
 *  SL_STATUS_OK if there are no errors.
 ******************************************************************************/
sl_status_t sparkfun_vcnl4040_set_proximity_resolution(
 ...
 *  SL_STATUS_TRANSMIT if I2C transmit failed.
 ******************************************************************************/
sl_status_t sparkfun_vcnl4040_is_interrupt(bool *isLight,
                                           bool *isDark,
                                           bool *isClose,
                                           bool *isAway);
