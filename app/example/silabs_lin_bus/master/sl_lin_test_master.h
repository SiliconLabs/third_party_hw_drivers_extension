 ...
 * 0.42 msecs safety margin after the transmission (8.4 bits, 16128 HF ticks at
 *   38.4 MHz)
 * and 0.9 msecs safety margin before the next one (18 bits, 34560 HF ticks at
 *   38.4 MHz)
...
/**
 * @brief      Counters for detected conflicts (transmitting 1 while the bus is
 *   0)
 */
