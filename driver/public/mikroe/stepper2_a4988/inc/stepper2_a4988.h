...
#define A4988_STEPPER_GPIO_CONFIG_DEFAULT \
  {                                       \
    ...
    A4988_STEPPER_SLEEP_PORT,             \
    A4988_STEPPER_SLEEP_PIN               \
  }
...
/***************************************************************************//**
 * @brief
 *    Initializes GPIOs needed to interface with the AN4988 IC.
 *    Initializes the A4988 instance.
 * @param[in] stepper_inst
 *    A4988 instance.
 * @param[in] pwm_inst
 *    PWM instance for control AN4988 IC.
 *
 * @return
 ...
 *    a4988_stepper_set_speed() function.
 *
 * @param[in] inst
 *    A4988 instance.
 *
