...
#define SPARKFUN_AK9753_REVISION_VERSION             0

/************************************************/
/**\name    AK9753 Register addresses           */
/************************************************/
#define SPARKFUN_AK975X_WIA1                         0x00 // Company Code
#define SPARKFUN_AK975X_WIA2                         0x01 // Device ID
#define SPARKFUN_AK975X_INTST                        0x04
#define SPARKFUN_AK975X_ST1                          0x05
#define SPARKFUN_AK975X_IR1                          0x06
#define SPARKFUN_AK975X_IR2                          0x08
#define SPARKFUN_AK975X_IR3                          0x0A
#define SPARKFUN_AK975X_IR4                          0x0C
#define SPARKFUN_AK975X_TMP                          0x0E
#define SPARKFUN_AK975X_ST2                          0x10 // Dummy register
#define SPARKFUN_AK975X_ETH13H_LOW                   0x11
#define SPARKFUN_AK975X_ETH13H_HIGH                  0x12
#define SPARKFUN_AK975X_ETH13L_LOW                   0x13
#define SPARKFUN_AK975X_ETH13L_HIGH                  0x14
#define SPARKFUN_AK975X_ETH24H_LOW                   0x15
#define SPARKFUN_AK975X_ETH24H_HIGH                  0x16
#define SPARKFUN_AK975X_ETH24L_LOW                   0x17
#define SPARKFUN_AK975X_ETH24L_HIGH                  0x18
#define SPARKFUN_AK975X_EHYS13                       0x19
#define SPARKFUN_AK975X_EHYS24                       0x1A
#define SPARKFUN_AK975X_EINTEN                       0x1B
#define SPARKFUN_AK975X_ECNTL1                       0x1C
#define SPARKFUN_AK975X_CNTL2                        0x19
#define SPARKFUN_AK975X_EKEY                         0x50

/************************************************/
/**\name    AK9753 EEPROM addresses             */
/************************************************/
#define SPARKFUN_AK975X_EETH13H_LOW                  0X51
#define SPARKFUN_AK975X_EETH13H_HIGH                 0X52
#define SPARKFUN_AK975X_EETH13L_LOW                  0X53
#define SPARKFUN_AK975X_EETH13L_HIGH                 0X54
#define SPARKFUN_AK975X_EETH24H_LOW                  0X55
#define SPARKFUN_AK975X_EETH24H_HIGH                 0X56
#define SPARKFUN_AK975X_EETH24L_LOW                  0X57
#define SPARKFUN_AK975X_EETH24L_HIGH                 0X58
#define SPARKFUN_AK975X_EEHYS13                      0X59
#define SPARKFUN_AK975X_EEHYS24                      0X5A
#define SPARKFUN_AK975X_EEINTEN                      0X5B

/***************************************************************************//**
 * @brief
 *    Typedef for Valid sensor modes - Register ECNTL1
 ******************************************************************************/
typedef enum sparkfun_ak9753_mode
{
  SPARKFUN_AK975X_MODE_STANDBY = 0b000,
  SPARKFUN_AK975X_MODE_EEPROM_ACCESS = 0b001,
  SPARKFUN_AK975X_MODE_SINGLE_SHOT = 0b010,
  SPARKFUN_AK975X_MODE_0 = 0b100,
  SPARKFUN_AK975X_MODE_1 = 0b101,
  SPARKFUN_AK975X_MODE_2 = 0b110,
  SPARKFUN_AK975X_MODE_3 = 0b111
}sparkfun_ak9753_mode_t;

/***************************************************************************//**
 * @brief
 *    Typedef for Valid digital filter cutoff frequencies.
 ******************************************************************************/
typedef enum sparkfun_ak9753_cutoff_freq
{
  SPARKFUN_AK975X_FREQ_0_3HZ = 0b000,
  SPARKFUN_AK975X_FREQ_0_6HZ = 0b001,
  SPARKFUN_AK975X_FREQ_1_1HZ = 0b010,
  SPARKFUN_AK975X_FREQ_2_2HZ = 0b011,
  SPARKFUN_AK975X_FREQ_4_4HZ = 0b100,
  SPARKFUN_AK975X_FREQ_8_8HZ = 0b101
}sparkfun_ak9753_cutoff_freq_t;

// EEPROM functions
#define SPARKFUN_AK975X_EEPROM_MODE         0b11000001
#define SPARKFUN_AK975X_EKEY_ON             0b10100101 // 0b10100101=0xA5
...
} sparkfun_ak9753_core_version_t;
 ...
 *    @li @ref SL_INVALID_PARAMETER if invalid parameter.
 ******************************************************************************/
sl_status_t sparkfun_ak9753_get_raw_temp(uint16_t *raw_temp_data);
 ...
 *    @li @ref SL_INVALID_PARAMETER if invalid parameter.
 ******************************************************************************/
sl_status_t sparkfun_ak9753_set_hysteresis_eeprom_ir24(
 ...
 *    @li @ref SL_INVALID_PARAMETER if invalid parameter.
 ******************************************************************************/
sl_status_t sparkfun_ak9753_set_hysteresis_eeprom_ir13(
  uint8_t hysteresis_value);
