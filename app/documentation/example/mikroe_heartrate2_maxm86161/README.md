...
2. Copy the file [app.c](https://github.com/SiliconLabs/platform_hardware_drivers_sdk_extensions/tree/master/app/example/mikroe_heartrate2_maxm86161) (overwriting existing file), into the project root folder.
